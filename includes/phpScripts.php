...
if (isset($_POST["btnAddMS"])) {
	...
	$Membership_price = $_POST["txtMprice"];

	$sql = "INSERT INTO membership(ms_name,ms_description,ms_type,ms_price) VALUES ('" . $Membership_name . "','" . $Membership_description . "','" . $Membership_type . "','" . $Membership_price . "')";
