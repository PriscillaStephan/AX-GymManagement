    ...
    <div class="container">
        ...
        <div class="invoice-content row px-5 pt-5">
            ...
            <div class="col-6 text-right total-field">
                ...
                <h1 class="gray-ish">634,57 <span class="curency">&dollar;</span></h1>
            </div>
        </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>1</td>
                            <td>25 <span class="currency">&dollar;</span></td>
                            <td>5 %</td>
                            <td>5 %</td>
                            <td class="text-right">28,75 <span class="currency">&dollar;</span></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                ...
                <table class="table table-borderless">
                    <tbody>
                        <tr>
                            ...
                            <td class="text-right">75 <span class="currency ">&dollar;</span></td>
                        </tr>
                        <tr>
                            <th scope="row gray-ish">VAT</th>
                            <td class="text-right">11,25 <span class="currency">&dollar;</span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="text-right">7,5 <span class="currency">&dollar;</span></td>
                        </tr>
                        <tr class="last-row">
                            <th scope="row">
                                <h4>Total</h4>
                            ...
                            <td class="text-right">
                                <h4><span class="currency">&dollar;</span> 90,25</h4>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <p class="text-center pb-3"><em> Taxes will be calculated in &dollar; regarding transport and other taxable services.</em></p>
    </div>
